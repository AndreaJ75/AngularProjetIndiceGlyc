...
export class AlimentListService {

  alimentToCalculate : Aliment;

  alimentList2 : Aliment[]  = [{
    "ig": 110,
    "carbs": 4.5,
    "name": "Bière"
  },
  ...
  getAlimentToCalculate(aliment){

    const index: number = this.alimentList.indexOf(aliment);
    this.alimentToCalculate = this.alimentList[index];
    console.log('liste de aliments ' + this.alimentToCalculate);

    return this.alimentToCalculate;
  }
}
